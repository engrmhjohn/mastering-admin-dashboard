<div class="navbar-right">
    <ul class="navbar-nav">
                        ...
                        <li>
                            <div class="progress-container progress-primary">
                                ...
                                <ul class="list-unstyled team-info">
                                    ...
                                    <li>
                                        <img src="{{ asset('adminAssets') }}/images/xs/avatar4.jpg"
                                            alt="Avatar">
                                    </li>
                                </ul>
                            </div>
                        ...
                        <li>
                            <div class="progress-container">
                                ...
                                <ul class="list-unstyled team-info">
                                    <li class="m-r-15"><small>Team</small></li>
                                    <li>
                                        <img src="{{ asset('adminAssets') }}/images/xs/avatar10.jpg"
                                            alt="Avatar">
                                    </li>
                                    <li>
                                        <img src="{{ asset('adminAssets') }}/images/xs/avatar9.jpg"
                                            alt="Avatar">
                                    </li>
                                    <li>
                                        <img src="{{ asset('adminAssets') }}/images/xs/avatar8.jpg"
                                            alt="Avatar">
                                    </li>
                                    <li>
                                        <img src="{{ asset('adminAssets') }}/images/xs/avatar7.jpg"
                                            alt="Avatar">
                                    </li>
                                    <li>
                                        <img src="{{ asset('adminAssets') }}/images/xs/avatar6.jpg"
                                            alt="Avatar">
                                    </li>
                                </ul>
                            </div>
        ...
        <li><a href="#" onclick="event.preventDefault(); document.getElementById('logout').submit()" class="mega-menu" title="Sign Out"><i class="zmdi zmdi-power"></i>
                    ...
                    <ul class="list-unstyled">
                            ...
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object "
                                        src="{{ asset('adminAssets') }}/images/xs/avatar4.jpg" alt="">
                        ...
                        <li class="online">
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object "
                                        src="{{ asset('adminAssets') }}/images/xs/avatar5.jpg" alt="">
                                    <div class="media-body">
                        ...
                        <li class="offline">
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object "
                                        src="{{ asset('adminAssets') }}/images/xs/avatar2.jpg" alt="">
                                    <div class="media-body">
                        ...
                        <li class="me">
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object "
                                        src="{{ asset('adminAssets') }}/images/xs/avatar1.jpg" alt="">
                                    <div class="media-body">
                        ...
                        <li class="online">
                            <a href="javascript:void(0);">
                                <div class="media">
                                    <img class="media-object "
                                        src="{{ asset('adminAssets') }}/images/xs/avatar3.jpg" alt="">
                                    <div class="media-body">
